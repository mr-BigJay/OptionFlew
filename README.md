...
- **یک سرور، دو ربات:** هر دو `.env` باید **همان** مسیر کاربران را داشته باشند:
...
یک‌بار ساخت کاربر در پنل ادمین (روی **هر** دامنه) برای stable و enrich کافی است. گزارش‌ها در `data/` هر نصب جدا می‌مانند.
